...
public class UIElementToggler : MonoBehaviour
{
    ...
    public float time1 = 10f; // The time interval in seconds for toggling the UI element
    public float time2 = 20f;
    public float time3 = 30f;
    public float time4 = 40f; // The time interval in seconds for toggling the UI element
    public float time5 = 50f;
    public float time6 = 60f;
    public float time7 = 70f;
    ...
    private void Update()
    {
        ...
        else if (timer > time6 && timer <= time7)
        {
         ...
         else if (timer > time7) // && timer <= time7)
        {
            CHAT6.SetActive(false);
